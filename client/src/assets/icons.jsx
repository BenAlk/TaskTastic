...
export const EnvelopeIcon = ({ width = "20px", height = "20px", color = "currentColor", className= ""}) => {
    return (
    <svg width={width} height={height} className={className} viewBox="0 -5 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
        <path
...
export const ArrowIcon = ({ width = "30px", height = "30px", fill = "currentColor", className = ""}) => {
    ...
    <svg fill={fill} height={height} width={width} className={className} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330" xmlSpace="preserve">
        ...
        s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z" stroke={fill} strokeWidth="1"/>
    </svg>
);
}
...
export const HomeIcon = ({ width = "20px", height = "20px", color = "currentColor", className = ""}) => {
    return (
    <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22 22L2 22" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M2 11L6.06296 7.74968M22 11L13.8741 4.49931C12.7784 3.62279 11.2216 3.62279 10.1259 4.49931L9.34398 5.12486" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M15.5 5.5V3.5C15.5 3.22386 15.7239 3 16 3H18.5C18.7761 3 19 3.22386 19 3.5V8.5" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M4 22V9.5" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M20 9.5V13.5M20 22V17.5" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M15 22V17C15 15.5858 15 14.8787 14.5607 14.4393C14.1213 14 13.4142 14 12 14C10.5858 14 9.87868 14 9.43934 14.4393M9 22V17" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M14 9.5C14 10.6046 13.1046 11.5 12 11.5C10.8954 11.5 10 10.6046 10 9.5C10 8.39543 10.8954 7.5 12 7.5C13.1046 7.5 14 8.39543 14 9.5Z" stroke={color} strokeWidth="1.5"/>
    </svg>
)
}

HomeIcon.propTypes = commonPropTypes

export const EisenhowerIcon = ({ width="20px", height="20px", color="currentColor", className=""}) => {
    return (
    <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M3 2C2.44772 2 2 2.44772 2 3V10C2 10.5523 2.44772 11 3 11H10C10.5523 11 11 10.5523 11 10V3C11 2.44772 10.5523 2 10 2H3ZM4 9V4H9V9H4Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M14 2C13.4477 2 13 2.44772 13 3V10C13 10.5523 13.4477 11 14 11H21C21.5523 11 22 10.5523 22 10V3C22 2.44772 21.5523 2 21 2H14ZM15 9V4H20V9H15Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M13 14C13 13.4477 13.4477 13 14 13H21C21.5523 13 22 13.4477 22 14V21C22 21.5523 21.5523 22 21 22H14C13.4477 22 13 21.5523 13 21V14ZM15 15V20H20V15H15Z" fill={color} />
        <path fillRule="evenodd" clipRule="evenodd" d="M3 13C2.44772 13 2 13.4477 2 14V21C2 21.5523 2.44772 22 3 22H10C10.5523 22 11 21.5523 11 21V14C11 13.4477 10.5523 13 10 13H3ZM4 20V15H9V20H4Z" fill={color} />
    </svg>
)
}

EisenhowerIcon.propTypes = commonPropTypes

export const KanbanIcon = ({ width="20px", height="20px", color="currentColor", className="" }) => {
    return (
    <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9,3 L9,21 L15,21 L15,3 L9,3 Z M8,3 L3.5,3 C2.67157288,3 2,3.67157288 2,4.5 L2,19.5 C2,20.3284271 2.67157288,21 3.5,21 L8,21 L8,3 Z M16,3 L16,21 L20.5,21 C21.3284271,21 22,20.3284271 22,19.5 L22,4.5 C22,3.67157288 21.3284271,3 20.5,3 L16,3 Z M1,4.5 C1,3.11928813 2.11928813,2 3.5,2 L20.5,2 C21.8807119,2 23,3.11928813 23,4.5 L23,19.5 C23,20.8807119 21.8807119,22 20.5,22 L3.5,22 C2.11928813,22 1,20.8807119 1,19.5 L1,4.5 Z M4,6 L6,6 C6.55228475,6 7,6.44771525 7,7 L7,8 C7,8.55228475 6.55228475,9 6,9 L4,9 C3.44771525,9 3,8.55228475 3,8 L3,7 C3,6.44771525 3.44771525,6 4,6 Z M4,10 L6,10 C6.55228475,10 7,10.4477153 7,11 L7,12 C7,12.5522847 6.55228475,13 6,13 L4,13 C3.44771525,13 3,12.5522847 3,12 L3,11 C3,10.4477153 3.44771525,10 4,10 Z M11,6 L13,6 C13.5522847,6 14,6.44771525 14,7 L14,8 C14,8.55228475 13.5522847,9 13,9 L11,9 C10.4477153,9 10,8.55228475 10,8 L10,7 C10,6.44771525 10.4477153,6 11,6 Z M18,6 L20,6 C20.5522847,6 21,6.44771525 21,7 L21,8 C21,8.55228475 20.5522847,9 20,9 L18,9 C17.4477153,9 17,8.55228475 17,8 L17,7 C17,6.44771525 17.4477153,6 18,6 Z M18,10 L20,10 C20.5522847,10 21,10.4477153 21,11 L21,12 C21,12.5522847 20.5522847,13 20,13 L18,13 C17.4477153,13 17,12.5522847 17,12 L17,11 C17,10.4477153 17.4477153,10 18,10 Z M18,14 L20,14 C20.5522847,14 21,14.4477153 21,15 L21,16 C21,16.5522847 20.5522847,17 20,17 L18,17 C17.4477153,17 17,16.5522847 17,16 L17,15 C17,14.4477153 17.4477153,14 18,14 Z" fill={color} />
    </svg>
)
}

KanbanIcon.propTypes = commonPropTypes

export const SettingsIcon = ({ width = "20px", height = "20px", color = "currentColor", className="" }) => {
...
SettingsIcon.propTypes = commonPropTypes

export const TeamIcon = ({ width = "20px", height = "20px", color = "currentColor", className="" }) => {
    return (
...
TeamIcon.propTypes = commonPropTypes

export const TrophyIcon = ({ width = "20px", height = "20px", color = "currentColor", className="" }) => {
    return (
    <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
TrophyIcon.propTypes = commonPropTypes


export const ProjectsIcon = ({ width = "20px", height = "20px", fill = "currentColor", className="" }) => {
    return (
        <svg fill={fill} width={width} height={height} className={className}viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
ProjectsIcon.propTypes = commonPropTypes

export const TrashIcon = ({ width = "20px", height = "20px", stroke = "currentColor", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.17065 4C9.58249 2.83481 10.6937 2 11.9999 2C13.3062 2 14.4174 2.83481 14.8292 4" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M20.5 6H3.49988" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M18.3735 15.3991C18.1965 18.054 18.108 19.3815 17.243 20.1907C16.378 21 15.0476 21 12.3868 21H11.6134C8.9526 21 7.6222 21 6.75719 20.1907C5.89218 19.3815 5.80368 18.054 5.62669 15.3991L5.16675 8.5M18.8334 8.5L18.6334 11.5" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M9.5 11L10 16" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M14.5 11L14 16" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
    )
}
...
export const EditIcon = ({ width = "20px", height = "20px", stroke = "currentColor", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18 10L14 6M18 10L21 7L17 3L14 6M18 10L17 11M14 6L8 12V16H12L14.5 13.5M20 14V20H12M10 4L4 4L4 20H7" stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
...
export const CreateIcon = ({ width = "20px", height = "20px", fill = "currentColor", backgroundFill = "black", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" fill={backgroundFill} width="24" height="24"/>
            <g>
            <path d="M21 14v5c0 1.105-.895 2-2 2H5c-1.105 0-2-.895-2-2V5c0-1.105.895-2 2-2h5v2H5v14h14v-5h2z" fill={fill}/>
            <path d="M21 7h-4V3h-2v4h-4v2h4v4h2V9h4" fill={fill}/>
        </g>
</svg>
    )
}

CreateIcon.propTypes = commonPropTypes


export const UserIcon = ({ width = "20px", height = "20px", stroke = "currentColor", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="9" r="3" stroke={stroke} strokeWidth="1.5"/>
            <circle cx="12" cy="12" r="10" stroke={stroke} strokeWidth="1.5"/>
            <path d="M17.9691 20C17.81 17.1085 16.9247 15 11.9999 15C7.07521 15 6.18991 17.1085 6.03076 20" stroke={stroke} strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
        )
}

UserIcon.propTypes = commonPropTypes

export const CollapseIcon = ({ width = "20px", height = "20px", fill = "currentcolor", className = "" }) => {
    return (
        <svg fill={fill} width={width} height={height} className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
CollapseIcon.propTypes = commonPropTypes

export const ThumbsUpIcon = ({ width = "20px", height = "20px", fill = "currentcolor", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" >
            <path d="M0 0h48v48H0z" fill="none"/>
            <g id="Shopicon">
                <path d="M8,44h2V24c-1.145,0-2,0-2,0c-2.2,0-4,1.8-4,4v12C4,42.2,5.8,44,8,44z" fill={fill}/>
                <path d="M14,44h18.43c3.3,0,6.723-2.7,7.608-6l3.751-14c0.884-3.3-1.092-6-4.392-6c0,0-4.397,0-7.397,0s-2.128-3-2.128-3
                    ...
                    c0,0-0.449,1.579-1.841,2.445V44z" fill={fill}/>
            </g>
        </svg>
    )
}

ThumbsUpIcon.propTypes = commonPropTypes

export const ImportantIcon = ({ width="20px", height="20px", fill="currentcolor", className=""}) => {
    return (
...
ImportantIcon.propTypes = commonPropTypes

export const TasksIcon = ({ width = "20px", height = "20px", fill = "currentColor", className="" }) => {
    return (
        <svg fill={fill} xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={className} viewBox="0 0 32.045 32.046"xmlSpace="preserve">
            <g>
	            <g>
...
TasksIcon.propTypes = commonPropTypes

export const AddIcon = ({ width = "20px", height = "20px", fill = "currentColor", className = "" }) => {
    return (
        <svg width={width} height={height} className={className}viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8V11H16C16.5523 11 17 11.4477 17 12C17 12.5523 16.5523 13 16 13H13V16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16V13H8C7.44771 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11H11V8Z" fill={fill}/>
            <path fillRule="evenodd" clipRule="evenodd" d="M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM3.00683 12C3.00683 16.9668 7.03321 20.9932 12 20.9932C16.9668 20.9932 20.9932 16.9668 20.9932 12C20.9932 7.03321 16.9668 3.00683 12 3.00683C7.03321 3.00683 3.00683 7.03321 3.00683 12Z" fill={fill}/>
        </svg>
    )
}

AddIcon.propTypes = commonPropTypes

export const WarningIcon = ({ width = "20px", height = "20px", className = "" }) => {
    return (
        <svg width={width} height={height} className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="17" r="1" fill="#fff000"/>
            <path d="M12 10L12 14" stroke="#fff000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M3.44722 18.1056L10.2111 4.57771C10.9482 3.10361 13.0518 3.10362 13.7889 4.57771L20.5528 18.1056C21.2177 19.4354 20.2507 21 18.7639 21H5.23607C3.7493 21 2.78231 19.4354 3.44722 18.1056Z" stroke="#fff000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}

WarningIcon.propTypes = commonPropTypes
